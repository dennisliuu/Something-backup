...
class Line:
    ...
    def Start_Line(self,client=None,account_pack=None,fallback=None):
        ...
        # #檢查是否帳密失敗
        # try:
        #     self.Driver.find_element_by_css_selector("#login_incorrect")
        ...
        # self.Send_Mesg_To_Friend(mid="u290302175bef32c56a2d796e05172e0d",msg_body="hello")

    def send_mesg_to_all_friend(self, msg_body):
        for friend in self.Friend_List:
            self.Send_Mesg_To_Friend(friend.mid, msg_body)
            time.sleep(1)
...
if __name__ == '__main__':
    obj = Line(parse_dir="")
    obj.Start_Line(account_pack={"account": "", "password": ''})
