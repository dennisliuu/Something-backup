...
<div class="arlo_tm_wrapper_all">
    ...
    <div class="arlo_tm_mobile_header_wrap">
        <div class="main_wrap">
            <div class="logo">
                <img src="{{URL::asset('img/logo/mobile_logo.png')}}" alt="" />
            </div>
    ...
    <div class="arlo_tm_content">
        ...
        <div class="arlo_tm_leftpart_wrap">
            <div class="leftpart_inner">
                <div class="logo_wrap">
                    <a href="#"><img src="{{URL::asset('img/logo/desktop-logo.png')}}" alt="" /></a>
                </div>
                            ...
                            <div class="content hero">
                                <div class="inner_content">
                                    <div class="image_wrap">
                                        <img src="{{URL::asset('img/hero/img.png')}}" width="200px" height="200px" alt="" />
                                        <input type="file" id="imgupload" style="display:none;" name="profile_image"/>
                                    </div>
                                    <div class="name_holder">
                                        <h3 class="user_name">{{ Auth::user()->name }}</h3>
                                        <input type="text" id="user_name" name="name" style="display:none;border: 1px black solid" value="{{ Auth::user()->name }}"/>
                                    </div>
                                    <div class="text_typing">
                                        ...
                                        <input type="text" value="{{ Auth::user()->content }}" name="content" id="user_content" style="display:none;border: 1px black solid"/>
                                    </div>
                                    <div>
                                        <br>
                                        <br>
                                        <br>
                                        <img src="{{URL::asset('img/about/qrcode.png')}}" width="170px" alt="" srcset="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="author_wrap">
                                    <div class="leftbox">
                                        <div class="about_image_wrap parallax" data-relative-input="true">
                                            <div class="image layer" data-depth="0.1">
                                                <img src="{{URL::asset('img/about/550x640.jpg')}}" alt="" />
                                                <div class="inner" data-img-url="img/hero/img.png"></div>
                                            </div>
                                    ...
                                    <div class="rightbox">
                                        <div class="arlo_tm_mini_title_holder">
                                            <h4>I'm Chen and <span class="arlo_tm_animation_text_word"></span></h4>
                                        </div>
                                        <div class="definition">
                                            <p>Hi! My name is <strong>Chen</strong>. I am a Web Developer, and I'm very passionate and dedicated to my work. With 20 years experience as a professional Web developer, I have acquired the skills and knowledge necessary to make your project a success. I enjoy every step of the design process, from discussion and collaboration to concept and execution, but I find the most satisfaction in seeing the finished product do everything for you that it was created to do.</p>
                                        </div>
                                        <div class="about_short_contact_wrap">
                                            <ul>
                                                <li>
                                                    <span><label>Mail:</label> <a href="mailto:example@gmail.com">chen&#64;gmail.com</a></span>
                                                </li>
                                                <li>
                                                    <span><label>Phone:</label> <a href="#">0988-655-777</a></span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="buttons_wrap">
                                            ...
                                            <img src="{{URL::asset('img/about/qrcode.png')}}" alt="" srcset="" width="50%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="list_wrap">
                                <ul>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/camera-diaphragm.svg')}}" alt="" />
                                            </div>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/new-tab.svg')}}" alt="" />
                                            </div>
                                            <div class="title_service">
                                                <h3>Web Design</h3>
                                            </div>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/layers.svg')}}" alt="" />
                                            </div>
                                            <div class="title_service">
                                                <h3>Branding</h3>
                                            </div>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/share.svg')}}" alt="" />
                                            </div>
                                            <div class="title_service">
                                                <h3>Social Media</h3>
                                            </div>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/adobe-illustrator.svg')}}" alt="" />
                                            </div>
                                            <div class="title_service">
                                                <h3>Illustrator</h3>
                                            </div>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="{{URL::asset('img/svg/seo-performance-marketing-graphic.svg')}}" alt="" />
                                            </div>
                                            <div class="title_service">
                                                <h3>Marketing</h3>
                                            </div>
                                        ...
                                        <li class="design">
                                            <div class="entry arlo_tm_portfolio_animation_wrap" data-title="Aoc Productions" data-category="Design">
                                                <a href="portfolio-single.html">
                                                    <img src="{{URL::asset('img/portfolio/600x600.jpg')}}" alt="" />
                                            ...
                                            <ul class="owl-carousel">
                                                <li class="item">
                                                    <div class="inner">
                                                        ...
                                                        <div class="definitions_wrap">
                                                            <p>âArlo team are easy to work with and helped me make amazing websites in a short amount of time. Thanks guys for works.â</p>
                                                        </div>
                                                        <div class="name_holder">
                                                ...
                                                <li class="item">
                                                    <div class="inner">
                                                        ...
                                                        <div class="definitions_wrap">
                                                            <p>âWe were looking for a logo with a touch of modernism. Arlo grasped our needs and produced a stunning design.â</p>
                                                        </div>
                                                        <div class="name_holder">
                                                ...
                                                <li class="item">
                                                    <div class="inner">
                                                        ...
                                                        <div class="definitions_wrap">
                                                            <p>âAwesome to work with Arlo. Good organized, easy to communicate with, responsive with next iterations.â</p>
                                                        </div>
                                                        <div class="name_holder">
                                ...
                                <ul class="total">
                                    <li class="wow fadeInUp" data-wow-duration="1.2s">
                                        <div class="inner_list">
                                            <div class="image_wrap">
                                                <img class="small" src="{{URL::asset('img/blog/500x350.jpg')}}" alt="" />
                                                <img class="big" src="{{URL::asset('img/blog/1170x450.jpg')}}" alt="" />
                                                <div class="news_image" data-url="{{URL::asset('img/blog/1.jpg')}}"></div>
                                    ...
                                    <li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
                                        <div class="inner_list">
                                            <div class="image_wrap">
                                                <img class="small" src="{{URL::asset('img/blog/500x350.jpg')}}" alt="" />
                                                <img class="big" src="{{URL::asset('img/blog/1170x450.jpg')}}" alt="" />
                                                <div class="news_image" data-url="{{URL::asset('img/blog/2.jpg')}}"></div>
                                                <a class="link_news" href="index.html"></a>
                                            </div>
                                            <div class="definitions_wrap">
                                                <div class="date_wrap">
                                    ...
                                    <li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.4s">
                                        <div class="inner_list">
                                            <div class="image_wrap">
                                                <img class="small" src="{{URL::asset('img/blog/500x350.jpg')}}" alt="" />
                                                <img class="big" src="{{URL::asset('img/blog/1170x450.jpg')}}" alt="" />
                                                <div class="news_image" data-url="{{URL::asset('img/blog/3.jpg')}}"></div>
                                                <a class="link_news" href="index.html"></a>
                                            </div>
                                            <div class="definitions_wrap">
                                                <div class="date_wrap">
                            ...
                            <div class="container">
                                <div class="leftbox">
                                    ...
                                    <div class="short_info_wrap">
                                        <ul>
                                            <li><p><label>Email:</label><span><a href="mailto:example@gmail.com">chen@gmail.com</a></span></p></li>
                                            <li><p><label>Phone:</label><span>0988-655-777</span></p></li>
                                        </ul>
                                        <img src="{{URL::asset('img/about/qrcode.png')}}" alt="" srcset="" width="50%">
                                    </div>
                                </div>
...
<!--[if lt IE 10]> <script type="text/javascript" src="{{URL::asset('js/ie8.js')}}"></script> <![endif]-->
...
<script>
    $(document).ready(function(){
        $(document).on('change', '#user_name', function() {
            // alert(123);
            $.ajax({
                url: "http://resume.test/api/users/{{Auth::user()->id}}",
                type: "PATCH",
                data: {
                    "name": $('#user_name').val()
                },
        ...
        $(document).on('change', '#user_content', function() {
            // alert(123);
            $.ajax({
                url: "http://resume.test/api/users/{{Auth::user()->id}}",
                type: "PATCH",
        ...
        {{--    let fd = new FormData();--}}
        {{--    const files = $('#imgupload')[0].files[0];--}}
    ...
    // $('.card-img-top').click(function(){ $('#imgupload').trigger('click'); });
    $('.user_name').click(function(){ $('#user_name').show(); });
    $('.user_content').click(function(){ $('#user_content').show(); });
